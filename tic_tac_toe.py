...
flag = 0
d = {'one': None, 'two': None, 'three': None, 'four': None, 'five': None, 'six': None, 'seven': None, 'eight': None,
     'nine': None}
...
def change(a):
    ...
    if (a == 0):
        rset()
    elif (d.get('one') == 'X' and d.get('two') == 'X' and d.get('three') == 'X' or d.get('four') == 'X' and d.get(
            'five') == 'X' and d.get('six') == 'X' or d.get('seven') == 'X' and d.get('eight') == 'X' and d.get(
            'nine') == 'X' or d.get('one') == 'X' and d.get('five') == 'X' and d.get('nine') == 'X' or d.get(
            'three') == 'X' and d.get('five') == 'X' and d.get('seven') == 'X' or d.get('one') == 'X' and d.get(
            'four') == 'X' and d.get('seven') == 'X' or d.get('two') == 'X' and d.get('five') == 'X' and d.get(
            'eight') == 'X' or d.get('three') == 'X' and d.get('six') == 'X' and d.get('nine') == 'X'):
        l.config(text='X wins', fg='red')
        winner = 'X is the winner'
        d = {'one': None, 'two': None, 'three': None, 'four': None, 'five': None, 'six': None, 'seven': None,
             'eight': None, 'nine': None}
    elif (d.get('one') == 'O' and d.get('two') == 'O' and d.get('three') == 'O' or d.get('four') == 'O' and d.get(
            'five') == 'O' and d.get('six') == 'O' or d.get('seven') == 'O' and d.get('eight') == 'O' and d.get(
            'nine') == 'O' or d.get('one') == 'O' and d.get('five') == 'O' and d.get('nine') == 'O' or d.get(
            'three') == 'O' and d.get('five') == 'O' and d.get('seven') == 'O' or d.get('one') == 'O' and d.get(
            'four') == 'O' and d.get('seven') == 'O' or d.get('two') == 'O' and d.get('five') == 'O' and d.get(
            'eight') == 'O' or d.get('three') == 'O' and d.get('six') == 'O' and d.get('nine') == 'O'):
...
def timer_print():
    l1.config(text=datetime.datetime.now().strftime("%d-%h-%Y %H:%M:%S"))
    l1.after(1, timer_print)
